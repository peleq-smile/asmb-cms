 ...
 * @copyright 2019
 */
class PoolRanking extends Entity
{
    /**
     * @var integer
     */
     ...
     * @return string
     */
    public function getTeamNameFft()
    {
        return $this->team_name_fft;
    }

    /**
     * @param string $teamNameFft
     */
    public function setTeamNameFft($teamNameFft)
    {
        $this->team_name_fft = $teamNameFft;
    }
